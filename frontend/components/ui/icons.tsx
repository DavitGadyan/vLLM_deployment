 ...
 *
 * Deliberately not an icon library: this interface needs eleven glyphs, and a
 * dependency that ships a thousand is weight for nothing. Emoji are not used
 * as icons anywhere — they render inconsistently across platforms and read as
 * unserious in an operator tool.
 *
 * All icons are 24x24, 1.5 stroke, inherit `currentColor`, and are
 * `aria-hidden` because every one of them sits next to real text.
 */
